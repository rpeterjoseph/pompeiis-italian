      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-5">
            {/* Map placeholder */}
            <div className="relative rounded-2xl overflow-hidden shadow-md bg-[#e8e0d0] h-64 lg:h-80 border border-gray-200">
              <iframe
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="bg-white/90 rounded-xl p-4 text-center shadow-sm" style={{ display: "none" }}>
                  <p className="font-semibold text-[#2C2C2C]">1120 Military St</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <a
                ...
                className="flex flex-col items-center gap-2 bg-[#8B1A1A] hover:bg-[#A52020] text-white font-semibold px-4 py-4 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 shadow-md text-center"
              >
              ...
              <a
                ...
                className="flex flex-col items-center gap-2 bg-[#C9A84C] hover:bg-[#E8C96B] text-[#2C2C2C] font-semibold px-4 py-4 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 shadow-md text-center"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                className="flex flex-col items-center gap-2 bg-[#5C6B2E] hover:bg-[#6d7e37] text-white font-semibold px-4 py-4 rounded-2xl transition-all duration-200 hover:-translate-y-0.5 shadow-md text-center"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-[#FDF6E3] rounded-2xl p-5 border border-[#C9A84C]/15">
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-[#8B1A1A]/10 rounded-xl flex items-center justify-center text-[#8B1A1A] flex-shrink-0 mt-0.5">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {/* Right: Hours */}
          <div>
            <div className="bg-[#2C2C2C] rounded-2xl overflow-hidden shadow-md">
              ...
              <div className="px-6 py-4 bg-[#1a1a1a] border-t border-white/10">
            ...
            <div className="grid grid-cols-2 gap-4 mt-5">
              {[
                ...
                <div
                  key={badge.label}
                  className="bg-[#FDF6E3] rounded-xl p-4 border border-[#C9A84C]/15 hover:border-[#C9A84C]/40 transition-colors"
                >
